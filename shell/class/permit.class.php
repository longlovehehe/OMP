 ...
 */
    public function get_ag_permit($ep_arr,$ag_arr){
            ...
            $two_ceng=$this->get_ag_permit1(array ( 'ag_number' => $_SESSION['ag']['ag_number'] ), array ( 'aggents_number' => $_SESSION['ag']['ag_number'] , 'ag_level' => $_SESSION['ag']['ag_level'] ) );
            $c_phone = $_SESSION['ag']['ag_phone_num'] - $two_ceng['phone'];
            $c_dispatch = $_SESSION['ag']['ag_dispatch_num'] - $two_ceng['dispatch'];
            $c_gvs = $_SESSION['ag']['ag_gvs_num'] - $two_ceng['gvs'];
            //当前代理已分配许可
