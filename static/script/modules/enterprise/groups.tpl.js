...
function getinfo(obj) {
    ...
    $("tr.head").html("<th style='padding: 0px ;'><div style='width:30px;'><input style='margin-left: 3px;' autocomplete='off'  type='checkbox' id='checkall' /></div></th> <th><div style='width:80px;'><%'姓名'|L%></div></th><th><div style='width:40px;'><%'类型'|L%></div></th> <th><div style='width:105px;'><%'号码'|L%></div></th> <th><div style='width:68px;'><%'级别'|L%></div></th> <th><div style='width:100px;'><%'默认组'|L%></div></th> <th><div style='width:97px;'><%'部门'|L%></div></th>");
...
//$("a.getall").removeClass("none");
    ...
    $("input[name=page]").val(0);
     $("tr.head").html("<th style='padding: 0px ;'><div style='width:30px;'><input style='margin-left: 3px;' autocomplete='off'  type='checkbox' id='checkall' /></div></th> <th><div style='width:115px;'><%'姓名'|L%></div></th><th><div style='width:40px;'><%'类型'|L%></div></th> <th><div style='width:105px;'><%'号码'|L%></div></th> <th><div style='width:135px;'><%'所属群组'|L%></div></th> <th><div style='width:100px;'><%'部门'|L%></div></th>");
    $.ajax({
        url: url,
        method: "GET",
        dataType: 'html',
