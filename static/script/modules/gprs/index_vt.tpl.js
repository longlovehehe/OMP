...
function edit_gprs(obj,id,imei){
   ...
   $(obj).next().removeClass("dis");
    ...
    var g_agents_id=$("input[name=g_agents_id"+id+"]").val();
    var g_intime=$("input[name=g_intime"+id+"]").val();
            ...
            success:function(msg){
                if(msg==1){
                    ...
                    $.ajax({
                        ...
                        dataType:"json",
                        data:{g_id:g_id,g_iccid:g_iccid,g_imsi:g_imsi,g_number:g_number,do:"edit",g_agents_id:g_agents_id,g_intime:g_intime},
                        success:function(msg){
                            if(msg.status==0){
                                layer.msg(msg.msg);
