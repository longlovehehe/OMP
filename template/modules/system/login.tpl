						...
						<!-- <SPAN style="float: left;">
				       	...
				       	<SPAN style="">
				       		<!-- <A style="color: rgb(204, 204, 204); margin-right: 10px;" href="#">注册</A> --> 
                                                <a class="submit login button" style="background: rgb(168, 58, 57); padding: 9px 40px; border-radius: 4px; border: 1px solid rgb(168, 58, 57); border-image: none; color: rgb(255, 255, 255); font-size: 16px;font-weight: bold;cursor: pointer;" >{"登录"|L}</a>
				       </SPAN>
				   	</P>
				</DIV>
			</div>
