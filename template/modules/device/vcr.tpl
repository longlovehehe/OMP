{strip}
<div class="toolbar">
    <a href="?modules=device&action=mds" class="button">{"GQT-Server管理"|L}</a>
    <a href="?modules=device&action=vcr" class="button active">{"VCR管理"|L}</a>
    <a href="?modules=device&action=vcrs" class="button none">{"VCR-S管理"|L}</a>
</div>
<h2 class="title">{"VCR 列表"|L}</h2>

<div class="toptoolbar">
    <a href="?modules=device&action=device_add&d_type=vcr" class="button orange">{"新增设备"|L}</a>
</div>
<div class="toolbar">
...
<div class="toolbar">
    ...
    <a id="refreshall" data="?p=modules/device/action/refresh"  class="button">{"批量状态刷新"|L}</a>
</div>
