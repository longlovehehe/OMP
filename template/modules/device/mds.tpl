{strip}
<!-- <div class="toolbar ">
    <a href="?m=device&a=server" class="button active">{"{$smarty.session.ident}-Server管理"|L}</a>
...
<div class="toptoolbar">
    <a href="?m=device&a=device_add&d_type=GQT-Server" class="button orange">{"新增设备"|L}</a>
</div>
<div class="toolbar">
    <form action="?m=device&a=mds_item" id="form" method="post">
        ...
        <div class="line">
            <label>{"外网地址"|L}：</label>
            <input autocomplete="off"  class="autosend" name="d_ip2" type="text" />
        </div>
        ...
        <div class="line none">
            <label>{"SIP端口"|L}：</label>
            <input autocomplete="off"  class="autosend" name="d_sip_port" type="text" />
        </div>
        <div class="line">
            <label>{"状态"|L}：</label>
