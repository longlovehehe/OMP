{strip}
<!-- <div class="toolbar ">
    <a href="?m=device&a=server" class="button active">{"{$smarty.session.ident}-SS管理"|L}</a>
...
<div class="toptoolbar">
    <a href="?m=device&a=ss_add&d_type=GQT-SS" class="button orange">{"新增设备"|L}</a>
</div>
<div class="toolbar">
    <form action="?m=device&a=ss_item" id="form" method="post">
        <input autocomplete="off"  name="modules" value="device" type="hidden" />
        <input autocomplete="off"  name="action" value="ss_item" type="hidden" />
        <input autocomplete="off"  name="d_type" value="ss" type="hidden" />
