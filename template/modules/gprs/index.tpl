...
<div class="toolbar">
    <form action="?m=gprs&a=gprs_item" id="form" method="post">
        ...
        <div class="line">
            <label>{"批次"|L}：</label>
            <input autocomplete="off"  class="autosend" name="g_batch" type="text" />
        </div>
        <div class="line">
            <label>{"开卡日"|L}：</label>
            <input autocomplete="off"  class="autosend" name="g_a_date" type="text" />
        </div>
        <div class="line">
            <label>{"入库单号"|L}：</label>
            <input autocomplete="off"  class="autosend" name="g_in_number" type="text" />
        </div>
        <div class="line">
            <label>{"所属代理商"|L}：</label>
        ...
        <div class="line">
            <label>{"入库时间"|L}：</label>
            <input autocomplete="off" name="g_intime" type="text" />
        </div>
