...
<div class="toolbar mactoolbar ">
    ...
    <a href="?m=cms&a=index_console" class="button active">{"Console"|L}</a>
    <a href="?m=cms&a=index_keeper" class="button">{"Keeper"|L}</a>
</div>

<div class="block">
    <label class="title" style="fimlay-font:微软雅黑;
           color:#535353; font-size:13px;font-weight:bold;" >Console{"软件包"|L} </label>
    <div class="t-android">
        <div class="nav_head">
            <table >
                <tr>
        ...
        <div class="control">
            <table id="android-table" >
                {foreach name=list item=infoa from=$console_info}
        ...
        <div class="fk">
            ...
            <a class="button"  href = "javascript:void(0)" onclick = "edit_console_dir();">{"修改"|L}</a>
            <a class="button"  href = "javascript:void(0)" onclick = "del_console_dir();">{"删除"|L}</a>
            <a class="button"  href = "javascript:void(0)" onclick = "empty_console_dir();">{"清空"|L}</a>
        </div>
    </div>
</div>
<br />
