...
<div class="toptoolbar">{* <a class="create_record button" href="?m=account&a=create_record">{"报表配置页"|L}</a>*} <a class="export button">{"导出"|L}</a></div>
{*<div class="block">
...
<form id="form" action="?m=account&a=account_item" method="post">
    ...
    <input autocomplete="off"  name="type" value="emp" type="hidden" />
