...
<form id="form" class="base mrbt10" action="?modules=enterprise&action=save_shell">
    ...
    <div class="block">
        ...
        <input   autocomplete="off" value="{$data.e_name}" ep_name="true"  maxlength="64" name="e_name" type="text" required="true" />
    </div>
    <div class="block">
        <label class="title">{"企业注册号"|L}：</label>
        <input   autocomplete="off" maxlength="64" name="e_regis_code" value="{$data.e_regis_code}" type="text" />
    </div>
    <div class="block">
        <label class="title">{"企业地址"|L}：</label>
        <input    autocomplete="off" value="{$data.e_addr}" {*addr="true"*}  maxlength="64" name="e_addr" type="text" required="true" />
    </div>
    <div class="block">
    ...
    <div class="block">
        ...
        <input    autocomplete="off"  maxlength="64" value="{$data.e_industry}" name="e_industry" type="text" />
    </div>
    <div class="block">
        <label class="title">{"名字"|L}：</label>
        <input    autocomplete="off"  placeholder="{'名字'|L}" maxlength="32" value="{$data.e_contact_name}" chinese="true" name="e_contact_name" type="text"  required="true" />
    </div>
    <div class="block">
        <label class="title">{"姓氏"|L}：</label>
         <input    autocomplete="off"  placeholder="{'姓氏'|L}" maxlength="32" value="{$data.e_contact_surname}" chinese="true" name="e_contact_surname" type="text"  required="true" />
    </div>
    <div class="block">
        <label class="title">{"联系电话"|L}：</label>
         <input class="mobile-number" maxlength="32" mobile1="true" type="text" style="height: 28px;width: 245px;border:1px solid #ccc;" name="e_contact_phone" value="{$data.e_contact_phone}" required="true"/>
        {*<input     autocomplete="off" placeholder="{'国家代码'|L}" style="width: 60px;" value="{$data.e_contry_num}" maxlength="4" name="e_contry_num" type="text" required="true" /> + 
        <input mobile="true"    autocomplete="off" placeholder="{'手机号码'|L}" value="{$data.e_contact_phone}"  maxlength="32" name="e_contact_phone" type="text" required="true" />*}
    </div>
    <div class="block">
        <label class="title">{"联系传真"|L}：</label>
        <input fox="true"    autocomplete="off"  maxlength="32" value="{$data.e_contact_fox}" name="e_contact_fox" type="text" />
    </div>
    <div class="block">
        <label class="title">{"邮箱"|L}：</label>
        <input    autocomplete="off"  maxlength="32" value="{$data.e_contact_mail}" email="true" name="e_contact_mail" type="text" required="true"  />
    </div>
    <div class="block">
    ...
    <div class="block">
        ...
        <input     autocomplete="off"  maxlength="32" value='{$data.e_mds_phone}' name="e_mds_phone" type="text" required="true" digits ="true" {if $data.e_agents_id !=0}readonly{/if}/>
    </div>
    <div class="block">
        <label class="title">{"分配调度台用户数"|L}：</label>
        <input     autocomplete="off"  maxlength="32" value='{$data.e_mds_dispatch}' name="e_mds_dispatch" type="text"  digits ="true" {if $data.e_agents_id !=0}readonly{/if}/>
    </div>
    <div class="block">
        <label class="title">{"分配GVS用户数"|L}：</label>
        <input     autocomplete="off"  maxlength="32" value='{$data.e_mds_gvs}' name="e_mds_gvs" type="text"  digits ="true" {if $data.e_agents_id !=0}readonly{/if}/>
    </div>
    {if $data.e_vcr_id > 0}
    <div class="block">
