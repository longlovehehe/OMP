        ...
        <div class='user_show'>
            <div class="toolbar">
                <form action="?modules=enterprise&action=users_item&e_id={$data.e_id}" id="userform" method="post" data='{literal}{"type":"append"}{/literal}'>
                    ...
                    <a form="userform" class="button submit userform eye_right" style="margin: 0">{"查询"|L}</a>
                </form>
            </div>
                ...
                <form class='data'>
                    <table class="base" >
                        <tr class='head' id="user_list">
                            <th>
                        <div style="width: 25px;"><input autocomplete="off" style="" type="checkbox" id="checkall" /></div>
                        </th>
                        <th><div style="width:150px;">{"姓名"|L}</div></th>
                        <th><div style="width:40px;">{"类型"|L}</div></th>
                        <th><div style="width:100px;">{"号码"|L}</div></th>
                        <th class="rich group "><div style="width:210px;">{"部门"|L}</div></th>
                        </tr>
                    </table>
...
<div id="dialog-edit" class="hide" title="Title">
    <form action="?modules=enterprise&action=usergroup_save&e_id={$data.e_id}" id="form" class="form">
        ...
        <div class="block">
            ...
            <input autocomplete="off"  value="0" name="ug_weight" type="text" required="true" range="[-999999999,999999999]">
