...
<div class="navicon">
	...
	{if $data.e_id eq 999999}{else}
        <div class="ListIcon autoactive none" action="admins">
        ...
        <!-- <div class="ListIcon autoactive"  action="index">
            <div class="Icon icon4 _4_jpg"></div>
            <div class="ListIconItem ">
                <h3><a href="?m=enterprise&amp;a=contract&amp;e_id={$data.e_id}" >{"用户合同"|L}</a></h3>
                <p>{"企业用户合同批量新增、编辑及用户合同历史记录等"|L}</p>
            </div>
        </div> -->
        <div class="ListIcon autoactive" action="export">
            <div class="Icon icon7 _7_jpg"></div>
            <div class="ListIconItem">
