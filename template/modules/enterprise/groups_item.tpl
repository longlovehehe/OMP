...
<tr class="gp_line">
    <td style="padding: 0px;display:inline;margin:0px;"><div style="width:30px;"><input style="margin-left: 2px;" {if $item.u_sub_type eq 3}disabled="disabled"{/if} onclick="getnum();" type="checkbox" name="checkbox[]" value="{$item.u_number}" class="cb" /><div><div class="total none">{$total}</div></td>
                <td style="padding: 0px 5px;" class="linebr title" title="{$item.u_name}"><div style="width:110px;">{$item.u_name|mbsubstr:5}</div></td>
                ...
                <td style="padding: 0px 5px;"><div style="width:100px;">{$item.u_number}</div></td>
                <td  style="padding: 0px 5px;"><div style="width:130px;">
