...
<form id="form" class="base mrbt10" action="?modules=enterprise&action=save_shell">
    <div class="block">
        ...
        <input  autocomplete="off" ep_name="true"  maxlength="64" name="e_name" type="text" required="true" />
    </div>
    <div class="block">
        <label class="title">{"企业注册号"|L}：</label>
        <input   autocomplete="off" maxlength="64" name="e_regis_code" type="text" />
    </div>
    <div class="block">
        <label class="title">{"企业地址"|L}：</label>
        <input  maxlength="64" autocomplete="off" {*addr="true"*}  name="e_addr" type="text" required="true" />
    </div>
    <div class="block">
        <label class="title">{"企业位置"|L}：</label>
        <input  autocomplete="off" maxlength="64" name="e_location" type="text"/>
    </div>
    <div class="block">
        <label class="title">{"行业"|L}：</label>
        <input    autocomplete="off"  maxlength="64" name="e_industry" type="text" />
    </div>
    <div class="block">
        <label class="title">{"名字"|L}：</label>
        <input    autocomplete="off" placeholder="{'名字'|L}" maxlength="32" value='' chinese="true" name="e_contact_name" type="text"  required="true" />
    </div>
    <div class="block">
        <label class="title">{"姓氏"|L}：</label>
        <input    autocomplete="off" placeholder="{'姓氏'|L}" maxlength="32" value='' chinese="true" name="e_contact_surname" type="text"  required="true" />
    </div>
    <div class="block">
        <label class="title">{"联系电话"|L}：</label>
        <input class="mobile-number" maxlength="32" mobile1="true" type="text" style="height: 28px;width: 242px;border:1px solid #ccc;" name="e_contact_phone" value="{$item.e_contact_phone}" required="true"/>
    </div>
    <div class="block">
        <label class="title">{"联系传真"|L}：</label>
        <input fox="true"    autocomplete="off"  maxlength="32" name="e_contact_fox" type="text" />
    </div>
    <div class="block">
        <label class="title">{"邮箱"|L}：</label>
        <input    autocomplete="off"  maxlength="32" value='' email="true" name="e_contact_mail" type="text" required="true"  />
    </div>
    <div class="block">
    ...
    <div class="block none">
        ...
        <input    autocomplete="off"  onpaste="return false" maxlength="32" e_pwd="true" name="e_pwd" type="text"/>
    </div>
    <div class="block">
    ...
    <div class="block none">
        ...
        <input    autocomplete="off"  maxlength="32" value='0' name="e_mds_call" type="text" required="true" digits ="true" />
    </div>
    <div class="block">
        <label class="title">{"分配手机用户数"|L}：</label>
        <input     autocomplete="off"  maxlength="32" value='0' name="e_mds_phone" type="text" required="true" digits ="true" />
    </div>
    <div class="block">
        <label class="title">{"分配调度台用户数"|L}：</label>
        <input     autocomplete="off"  maxlength="32" value='0' name="e_mds_dispatch" type="text"  digits ="true" />
    </div>
    <div class="block">
        <label class="title">{"分配GVS用户数"|L}：</label>
        <input    autocomplete="off"  maxlength="32" value='0' name="e_mds_gvs" type="text"  digits ="true" />
    </div>
    <div class="block">
...
<h2 class="title">{"企业管理员配置"|L}</h2>   
     <div class="block">
        <label class="title">{"名字"|L}：</label>
       <input    autocomplete="off" placeholder="{'名字'|L}" maxlength="32" value='' chinese="true" name="em_admin_name" type="text"  required="true" />
    </div>
     <div class="block">
        <label class="title">{"姓氏"|L}：</label>
       <input    autocomplete="off"  placeholder="{'姓氏'|L}" maxlength="32" value='' chinese="true" name="em_surname" type="text"  required="true" />
    </div>
     <div class="block">
        <label class="title">{"管理员密码"|L}：</label>
        <input  maxlength="32" autocomplete="off"  value='' paswd="true" id="password" name="em_pswd" type="password" required="true"  />
    </div>
    <div class="block">
        <label class="title">{"手机号"|L}：</label>
        <input class="mobile-number" maxlength="32" mobile1="true" type="text" style="height: 28px;width: 242px;border:1px solid #ccc;" name="em_phone" value="{$item.em_phone}" required="true"/>
        {*
    ...
    <div class="block">
        <label class="title">{"邮箱"|L}：</label>
        <input    autocomplete="off"  maxlength="32" value='' email="true" name="em_mail" type="text" required="true"  />
    </div>
    <div class="block">
