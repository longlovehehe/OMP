...
<?php /*%%SmartyHeaderCode:1549576232733b2c02-53424521%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1549576232733b2c02-53424521',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_576232734c04c4_72952956',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_576232734c04c4_72952956')) {function content_576232734c04c4_72952956($_smarty_tpl) {?><!DOCTYPE html>
<HTML class="login">
    <HEAD>
						...
						<!-- <SPAN style="float: left;">
				       	...
				       	<SPAN style="">
				       		<!-- <A style="color: rgb(204, 204, 204); margin-right: 10px;" href="#">注册</A> --> 
                                                <a class="submit login button" style="background: rgb(168, 58, 57); padding: 9px 40px; border-radius: 4px; border: 1px solid rgb(168, 58, 57); border-image: none; color: rgb(255, 255, 255); font-size: 16px;font-weight: bold;cursor: pointer;" ><?php echo L("登录");?>
</a>
				       </SPAN>
				   	</P>
				</DIV>
